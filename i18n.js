...
const MESSAGES = {
  es: {
    meta: {
      ...
      description:
        "SmartCart compara precios de góndola, optimiza rutas multi-tienda y valida datos con la comunidad. FlowState Tech.",
    },
    a11y: {
    ...
    footer: {
      ...
      linksTitle: "Enlaces",
      linkReport: "Repositorio del informe",
      ...
      startupBody: "Proyecto académico — UPC · Aplicaciones para Dispositivos Móviles · 202610",
    },
    hero: {
      eyebrow: "App móvil: comparador de precios de góndola y rutas multi-tienda",
      title1: "Tu canasta,",
      title2: "más barata",
      title3: "y en menos tiempo",
      leadHtml:
        'SmartCart es una <strong>app móvil</strong> que centraliza precios presenciales entre supermercados y tiendas de conveniencia, calcula tu <strong>ruta óptima</strong> y refuerza datos con validación comunitaria. Más contexto en el <a href="https://github.com/FlowState-Tech/smartcart-report" target="_blank" rel="noopener">informe del proyecto</a>.',
    ...
    home: {
      ...
      asideEyebrow: "Proyecto académico",
      asideTitle: "Basado en evidencia",
      asideP1:
        "Las pantallas y flujos siguen historias de usuario, Lean UX y el modelado de dominio documentado en el informe del curso (UPC · Apps móviles · 2026-10).",
      asideP2: "No sustituimos al cajero ni al delivery: potenciamos la decisión antes y durante tu salida a comprar.",
      asideReport: "Ver informe en GitHub",
      segImgAlt: "Familia planificando compras en casa",
      colabEyebrow: "Personas detrás del producto",
      colabTitle: "Colaboradores",
      colabBody:
        "Cinco estudiantes de Ingeniería de Software (UPC): Anjali Amaro, Joseph Chavez, Katherine Mejia, Kevin Pardo y Stephano Valdivia — del informe al prototipo móvil de SmartCart.",
    ...
    demo: {
      ...
      lead: "Ajusta los valores para ver un <strong>ahorro total</strong> estimado (demo educativa, sin backend).",
    ...
    beneficios: {
      title: "Beneficios alineados al producto",
      lead: "Contenido derivado de la propuesta de valor y las hipótesis Lean UX del informe SmartCart.",
      lead2:
        "Cada beneficio conecta con historias de usuario del backlog: presupuesto, desplazamiento y confianza en datos.",
      ...
      proIntro:
        "En el informe separamos <strong>ahorro monetario</strong>, <strong>ahorro de tiempo</strong> y <strong>confianza en datos</strong>. La app materializa esas capas en flujos táctiles sencillos.",
      ...
      proLi3: "Base documental en GitHub para auditar decisiones de producto y arquitectura.",
    ...
    dominio: {
      title: "Dominio impulsado por DDD",
      lead: "SmartCart se modeló con <strong>Event Storming</strong>, <strong>Domain Message Flows</strong> y <strong>Bounded Contexts</strong> (estrategia y táctica) documentados en el repositorio del informe.",
      classTitle: "Clasificación estratégica",
      pillCore: "Core",
      pillSupport: "Supporting",
      pillGeneric: "Generic",
      flowsTitle: "Flujos entre contextos",
      flowsIntro: "Escenarios de integración del modelado de mensajes de dominio (vista resumida).",
    ...
    contextDetail: {
      ...
      github: "Abrir informe en GitHub",
    },
    mapa: {
    ...
    informe: {
      ...
      lead: "Informe académico con Lean UX, needfinding, historias de usuario, DDD estratégico y táctico, y arquitectura C4.",
      cta: "Ver repositorio smartcart-report",
      esTitle: "Event Storming",
      esBody: "Big Picture documentado con apertura, exploración y cierre del flujo de eventos de dominio.",
      ubTitle: "Lenguaje ubicuo",
      ubBody: "Términos compartidos: Canasta, Ruta óptima, Error de precio, Trust Profile, ShoppingRoute…",
      ubBtn: "Leer glosario en el README",
      esAlt: "Mural de Event Storming",
    },
    waitlist: {
    ...
    descarga: {
      ...
      notifyLead: "Déjanos tu correo; en esta demo todo queda en tu navegador (localStorage), sin servidor.",
      ...
      privacyTitle: "Privacidad y demo",
      privacyP:
        "El formulario de aviso en esta landing solo guarda correos en tu navegador (localStorage) para simular un registro; no hay backend. En producción aplicaríamos consentimiento explícito y política de datos personales según normativa peruana.",
    ...
    nosotros: {
      ...
      valuesTitle: "Valores",
      valuesBody:
        "Transparencia, diseño centrado en evidencia (Lean UX) y ingeniería disciplinada — el informe académico documenta decisiones para que el producto sea auditable.",
      teamTitle: "Equipo y contexto",
      teamIntro:
        "SmartCart nace en la UPC (Aplicaciones para Dispositivos Móviles, 2026-10) como proyecto de startup con foco en experiencia real de compra, no en reparto a domicilio.",
      card1t: "Producto",
      ...
      storyTitle: "Historia del proyecto",
      storyP1:
      ...
      storyP2:
        "El equipo FlowState Tech combina producto, experiencia de usuario y arquitectura de software. El informe del curso documenta decisiones con historias de usuario, diagramas y flujos entre los módulos de la aplicación.",
    ...
    colab: {
      ...
      gridIntro:
        "Estudiantes de Ingeniería de Software de la UPC que desarrollan SmartCart en el curso de Aplicaciones para Dispositivos Móviles (2026-10).",
      ...
      ctaGithub: "Informe en GitHub",
    },
    faq: {
      title: "Preguntas frecuentes",
      lead: "Respuestas claras según tu perfil: compras en tienda, retail o curiosidad por el proyecto.",
      lead2:
        "Si no encuentras lo que buscas, revisa la sección Colaboradores o el repositorio del informe en GitHub.",
      ...
      t1q: "¿Dónde está el informe y el material del curso?",
      t1a:
        'En el repositorio público <a href="https://github.com/FlowState-Tech/smartcart-report" target="_blank" rel="noopener noreferrer">smartcart-report</a> en GitHub: Lean UX, historias de usuario, diagramas y decisiones de arquitectura.',
      t2q: "¿Qué guarda esta landing en mi navegador?",
      t2a:
        "Solo lo que indiques en el formulario de <strong>aviso de descarga</strong>: se guarda en <strong>localStorage</strong> en tu equipo, sin backend propio en esta demo. En producción habría consentimiento explícito y política de datos.",
      ...
      t4a:
        "En <strong>módulos separados</strong> (identidad, tiendas, planificación, recorrido, experiencia de usuario, notificaciones, etc.) para que escalar y mantener el código sea ordenado. Los detalles están en el informe del proyecto.",
    },
    layers: {
      Domain: "Domain",
    ...
    modal: {
      comparador: {
        ...
        html: `<p>Lee precios de góndola entre cadenas y formatos (volumen vs. proximidad). Incluye comparación por unidad de medida cuando hay datos de peso o volumen.</p><p><a href="https://github.com/FlowState-Tech/smartcart-report" target="_blank" rel="noopener noreferrer">Más en el informe →</a></p>`,
      },
      ruta: {
      ...
      bodyPlaceholder:
        "Toca la X, Esc o el fondo oscuro para cerrar. Más información en Beneficios y en el informe del proyecto.",
    },
  },
  en: {
    meta: {
      ...
      description:
        "SmartCart compares shelf prices, optimizes multi-store routes, and keeps data trustworthy with community validation. FlowState Tech.",
    },
    a11y: {
    ...
    footer: {
      ...
      linksTitle: "Links",
      linkReport: "Project report repository",
      linkNosotros: "About us",
      linkDescarga: "Download the app",
      linkFaq: "FAQ",
      linkColab: "Team",
      startupTitle: "Startup",
      startupBody: "Academic project — UPC · Mobile Applications · 202610",
    },
    hero: {
      eyebrow: "Mobile app: shelf-price comparator and multi-store routes",
      title1: "Your basket,",
      title2: "cheaper",
      title3: "in less time",
      leadHtml:
        'SmartCart is a <strong>mobile app</strong> that centralizes in-store prices across supermarkets and convenience stores, builds your <strong>optimal route</strong>, and reinforces data with community validation. More context in the <a href="https://github.com/FlowState-Tech/smartcart-report" target="_blank" rel="noopener">project report</a>.',
    ...
    home: {
      ...
      asideEyebrow: "Academic project",
      asideTitle: "Evidence-led",
      asideP1:
        "Screens and flows follow user stories, Lean UX, and the domain modeling documented in the course report (UPC · Mobile apps · 2026-10).",
      asideP2: "We do not replace cashiers or delivery: we strengthen decisions before and during your trip to the store.",
      asideReport: "View report on GitHub",
      segImgAlt: "Family planning shopping at home",
      colabEyebrow: "People behind the product",
      colabTitle: "Collaborators",
      colabBody:
        "Five Software Engineering students at UPC: Anjali Amaro, Joseph Chavez, Katherine Mejia, Kevin Pardo, and Stephano Valdivia — taking SmartCart from the report to a mobile prototype.",
    ...
    demo: {
      ...
      lead: "Adjust values to see estimated <strong>total savings</strong> (educational demo, no backend).",
    ...
    beneficios: {
      title: "Benefits aligned with the product",
      lead: "Derived from the value proposition and Lean UX hypotheses in the SmartCart report.",
      lead2: "Each benefit maps to backlog user stories: budget, travel, and trust in data.",
      ...
      proIntro:
        "The report separates <strong>monetary savings</strong>, <strong>time savings</strong>, and <strong>data trust</strong>. The app turns those layers into simple tactile flows.",
      ...
      proLi3: "GitHub documentation to audit product and architecture decisions.",
    ...
    dominio: {
      title: "Domain powered by DDD",
      lead: "SmartCart was modeled with <strong>Event Storming</strong>, <strong>Domain Message Flows</strong>, and <strong>Bounded Contexts</strong> (strategic & tactical) documented in the report repository.",
      classTitle: "Strategic classification",
      pillCore: "Core",
      pillSupport: "Supporting",
      pillGeneric: "Generic",
      flowsTitle: "Cross-context flows",
      flowsIntro: "Integration scenarios from domain message modeling (summary view).",
    ...
    informe: {
      ...
      lead: "Academic report with Lean UX, needfinding, user stories, strategic & tactical DDD, and C4 architecture.",
      cta: "View smartcart-report repository",
      esTitle: "Event Storming",
      esBody: "Big Picture with open, explore, and close stages of the domain event flow.",
      ubTitle: "Ubiquitous language",
      ubBody: "Shared terms: Basket, Optimal route, Price mismatch, Trust Profile, ShoppingRoute…",
      ubBtn: "Read glossary in README",
      esAlt: "Event Storming board",
    },
    waitlist: {
      title: "Waitlist",
    ...
    descarga: {
      ...
      notifyLead: "Leave your email; in this demo everything stays in your browser (localStorage), no server.",
      ...
      privacyP:
        "The launch-notify form on this landing only stores emails in your browser (localStorage) to simulate signup; there is no backend. In production we would add explicit consent and a privacy policy aligned with Peruvian regulation.",
    ...
    nosotros: {
      ...
      valuesTitle: "Values",
      valuesBody:
        "Transparency, evidence-led design (Lean UX), and disciplined engineering — the academic report documents decisions so the product stays auditable.",
      teamTitle: "Team & context",
      teamIntro:
        "SmartCart started at UPC (Mobile Applications, 2026-10) as a startup-style project focused on real shopping journeys, not home delivery.",
      card1t: "Product",
      ...
      storyP2:
        "FlowState Tech blends product, UX, and software architecture. The course report documents decisions with user stories, diagrams, and flows across the app’s modules.",
    ...
    colab: {
      ...
      gridIntro:
        "Software Engineering students at UPC building SmartCart for the Mobile Applications course (2026-10).",
      ...
      m2bio:
        "I'm Joseph Chavez, 19, in my seventh cycle of Software Engineering at UPC. I work with C++ and Python and have basic JavaScript knowledge. I believe academic performance carries into professional life, so I push to gain every experience I need for my technical and professional growth.",
      ...
      ctaGithub: "Report on GitHub",
    },
    faq: {
      title: "Frequently asked questions",
      lead: "Clear answers by profile: in-store shopping, retail, or learning about the project.",
      lead2: "If you need more detail, visit Collaborators or the report repository on GitHub.",
      ...
      t1q: "Where is the course report and materials?",
      t1a:
        'In the public <a href="https://github.com/FlowState-Tech/smartcart-report" target="_blank" rel="noopener noreferrer">smartcart-report</a> repo on GitHub: Lean UX, user stories, diagrams, and architecture notes.',
      t2q: "What does this landing store in my browser?",
      t2a:
        "Only what you submit in the <strong>download notice</strong> form: it’s saved in <strong>localStorage</strong> on your device — there is no custom backend in this demo. A production app would add explicit consent and a privacy policy.",
      ...
      t4a:
        "As <strong>separate modules</strong> (identity, stores, planning, journey, shopper experience, notifications, etc.) so the codebase can grow in a maintainable way. Details are in the project report.",
    },
    layers: {
      Domain: "Domain",
      Application: "Application",
    ...
    modal: {
      comparador: {
        ...
        html: `<p>Shelf prices across chains and formats (proximity vs. bulk). Includes per-kg or per-unit comparison when weight/volume data exists.</p><p><a href="https://github.com/FlowState-Tech/smartcart-report" target="_blank" rel="noopener noreferrer">More in the report →</a></p>`,
      },
      ruta: {
      ...
      bodyPlaceholder:
        "Tap X, Esc, or the dimmed background to close. More detail under Benefits and in the project report.",
    },
  },
};
